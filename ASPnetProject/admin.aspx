...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="cool-back flex items-center justify-center h-screen">
        <div class="glass w-1/2 flex items-center justify-center flex-col my-10" style="backdrop-filter: blur(12px)!important;">
            <h1 class="text-4xl border-b border-black my-5">Users: </h1>
            <h2><%= sqlSelect %></h2>
            <table class='border border-black table-auto border-collapse text-xl relative'>
                <%= st %>
            </table>
